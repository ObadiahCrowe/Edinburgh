...
/home/obadiah/Documents/OSDev/crosscompiler/bin/x86_64-elf-gcc -ffreestanding -mcmodel=large -mno-red-zone -mno-mmx -mno-sse -mno-sse2 -c kernel/boot/kerneljump.c -o build/kernel.o
