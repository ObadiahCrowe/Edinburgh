...
#Link kernel
echo "Linking kernel"
ld -n -o build/kernel.bin -T kernel/arch/x86_64/linker.ld build/arch/x86_64/boot.o build/arch/x86_64/long_mode_init.o build/arch/x86_64/multiboot_header.o
